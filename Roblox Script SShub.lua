...
if(gameid == 3198259055) then
    game.StarterGui:SetCore("SendNotification", {
        Title = "NOTIFY!";
        Text = "Game Found (SoulShatters)";
        Duration = "5";
        })
...
--Script MAIN
local Others = SShub:addPage("Others", 5012544693)
local SC1 = Others:addSection("Scripts")
local SC2 = Others:addSection("Humanoid")
local SC3 = Others:addSection("Others")
local SC4 = Others:addSection("Destroy Gui")
SC1:addButton(
    "CMD-X Fe Commands",
    function()
        loadstring(
...
SC2:addTextbox(
    ...
    "",
    function(Jump)
        local JP = game.Players.LocalPlayer.Character:WaitForChild("Humanoid")
        JP.JumpPower = Jump
    end
)
SC2:addTextbox(
    ...
    "",
    function(WalkS)
        local WS = game.Players.LocalPlayer.Character:WaitForChild("Humanoid")
        WS.WalkSpeed = WalkS
    end
)
...
--CRITICAL STRIKE--
            ...
            if(gameid == 111311599) then
                game.StarterGui:SetCore("SendNotification", {
                    Title = "NOTIFY!";
                    Text = "Game Found (CriticalStrike)";
                    Duration = "5";
                    })
...
local SShub = library.new("SShub", 5013109572)
local Others = SShub:addPage("Others", 5012544693)
local SC1 = Others:addSection("Scripts")
local SC2 = Others:addSection("Humanoid")
local SC3 = Others:addSection("Others")
