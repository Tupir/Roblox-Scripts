...
local SShubEsp = {
    ...
    Players = {
        Enabled = true,
        Name = {true, Color3.new(255,255,255)},
        Health = {true, Color3.new(255,255,255)},
        Team = {true, Color3.new(255,255,255)},
        Tool = {true, Color3.new(255,255,255)},
        Backpack = {false, Color3.new(255,255,255)},
        Tracers = {false, Color3.new(255,255,255)},
        Distance = {true, Color3.new(255,255,255)},
        Boxes = {true, Color3.new(255,255,255)},
