...
do
    ...
    function Funcs:AddColorPicker(Idx, Info, callback)
...
do
    ...
    function Funcs:AddInput(Idx, Info, callback)
        local Textbox = {
    ...
    function Funcs:AddToggle(Idx, Info, callback)
        local Toggle = {
    ...
    function Funcs:AddSlider(Idx, Info, callback)
    ...
    function Funcs:AddDropdown(Idx, Info, callback)
